...
class LatLonExtractorTest {
    @Test
    fun `check different url returns error if data is null`() =
        runTest {
    ...
    @Test
    fun `check different url returns correct results`() =
        runTest {
            val latLonExtractor = LatLonExtractor()
            ...
            assertEquals(
                ...
                actual =
                    latLonExtractor
                        .extractFromStringData("https://maps.app.goo.gl/HSUQp6K9L8z5efAY7")
                        .getOrNull(),
            )
            ...
            assertEquals(
                ...
                actual =
                    latLonExtractor
                        .extractFromStringData("https://maps.app.goo.gl/nWx4HL35gqPhHrif8")
                        .getOrNull(),
            )
            ...
            assertEquals(
                ...
                actual =
                    latLonExtractor
                        .extractFromStringData("https://maps.apple/p/ogrw-5mF-Pjyax")
                        .getOrNull(),
            )
